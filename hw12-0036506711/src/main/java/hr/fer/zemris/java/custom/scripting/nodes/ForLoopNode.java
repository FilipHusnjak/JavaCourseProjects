...
public class ForLoopNode extends Node {
	...
	public boolean equals(Object obj) {
		...
		return super.equals(obj) && forLoopNode.getVariable().equals(variable) 
				&& forLoopNode.getStartExpression().equals(startExpression)
				&& forLoopNode.getEndExpression().equals(endExpression) 
				&& (stepExpression == null ? forLoopNode.getStepExpression() == null : 
					stepExpression.equals(forLoopNode.getStepExpression()));
	}
	
	@Override
	public int hashCode() {
		return Objects.hash(super.hashCode() + variable.hashCode() + 
				startExpression.hashCode() + endExpression.hashCode() + 
				(stepExpression == null ? 0 : stepExpression.hashCode()));
	}
